...
namespace TcpGameServer
{
    ...
    public class TcpServer : NetServer<Client>, ITcpServer
    {
        ...
        private readonly IStateRequestRouter _requestRouter;

        public TcpServer(ILogger logger, IAuthenticator authenticator, IStateRequestRouter requestRouter, string host)
        {
            _logger = logger;
